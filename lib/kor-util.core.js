...
!(function(self){
	...
	**/
	self.isConsonant = function(char,autoConv){ return /^[\u3131-\u314e]/.test(char)||autoConv&&CHAR_CODE_AT_KO_PHONEME_BEGIN<=char.charCodeAt(0)&&char.charCodeAt(0)<CHAR_CODE_AT_KO_PHONEME_BEGIN+CHAR_COUNT__KO_CONSONANT||false; };
