	...
	function requireKorUtil () {
		...
		(function (module, exports) {
			...
			(function (factory) {
			    ...
			    var core = __importStar(require("./kor-util.core"));
			    __exportStar(require("./kor-util.syntax"), exports);
			    var syntax = __importStar(require("./kor-util.syntax"));
			    var korUtil = Object.assign({}, core, syntax);
			    exports.default = korUtil;
			}); 
